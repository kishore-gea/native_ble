...
class DisableAnimationsRule : TestRule {
    ...
    init {
        try {
            ...
            val asInterface: Method = windowManagerStubClazz.getDeclaredMethod("asInterface", IBinder::class.java)
            val serviceManagerClazz = Class.forName("android.os.ServiceManager")
            val getService: Method = serviceManagerClazz.getDeclaredMethod("getService", String::class.java)
